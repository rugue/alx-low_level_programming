...
/**
 * check97 - this check for correct number arguments
...
/**
 * check98 - this checks that file_from exists and can be read
 * @check: this checks if true of false
 * @file: file_from names
 * @fd_from: file descriptor of file_froms, or -1
...
/**
 * check100 - this help checks that file descriptors were closed properly
 * @check: this help checks if true or false
 * @fd: file descriptor
 *
 * Return: void
 */
 ...
 * @argc: this number of arguments passed
